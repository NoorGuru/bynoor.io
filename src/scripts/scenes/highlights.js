/**
 * Highlights Scene — Career impact cards with staggered entrance
 * animations from alternating directions, glow integration, and
 ...
 *
 * @module scenes/highlights
 * @see Requirements 15.2, 15.4, 15.6
 */
...
/**
 * Initialize the highlights scene.
 * @param {HTMLElement} el - The highlights scene root element
 */
function init(el) {
  sceneEl = el;
  cards = el.querySelectorAll('.highlights__card');
  ...
  // Initialize glow effect on cards with [data-glow] within this scene
  initGlow('.scene--highlights [data-glow]');
